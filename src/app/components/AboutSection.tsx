...
export function AboutSection() {
  ...
  <h2 className="text-3xl lg:text-5xl font-black text-gray-900 mb-6 leading-tight">
    عن مؤسسة {" "}
    <span className="text-[#f59e0b]">ذات</span>
  </h2>

  <p className="text-gray-600 text-lg leading-relaxed mb-6">
    مؤسسة <span className="text-[#f59e0b]">ذات</span> التعليمية هي جهة متخصصة في تقديم الخدمات التعليمية والاستشارات الأكاديمية للطلاب الراغبين في الدراسة داخل وخارج البلاد.
