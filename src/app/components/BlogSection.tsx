...
const articles = [
  {
    title: "أفضل 10 جامعات تركية لدراسة الهندسة باللغة الإنجليزية في 2025",
  ...
  {
    title: "تكلفة المعيشة في إسطنبول للطلاب: دليل عملي محدّث",
    excerpt: "قبل أن تقرر الدراسة في إسطنبول، من المهم أن تفهم التكاليف الحقيقية للمعيشة. في هذا المقال نقدم لك تفصيلاً دقيقاً لميزانية الطالب الشهرية...",
    ...
    <section id="blog" className="py-20 px-4" style={{ backgroundColor: "#f5f7fb" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
          ...
          <a
            href="#"
            className="flex items-center gap-2 text-sm font-bold px-5 py-3 rounded-xl transition-all hover:shadow-md"
            style={{ color: "#0d2b5e", border: "1.5px solid #0d2b5e30" }}
          >
            جميع المقالات
            <ArrowLeft size={16} />
          </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-5">
            {rest.map((article, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group cursor-pointer flex"
                style={{ border: "1px solid #e8ecf0" }}
              >
                ...
                <div className="p-4 flex-1">
                  ...
                  <h4 className="font-bold text-gray-900 text-sm leading-snug mb-2 group-hover:text-blue-900 transition-colors line-clamp-2">
                    {article.title}
                  </h4>
