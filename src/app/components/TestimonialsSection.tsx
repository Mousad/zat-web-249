...
const testimonials = [
  {
    ...
    text: "منصة د/ يسرا غيّرت مسار حياتي بالكامل. كنت أحلم بالدراسة في الخارج لكنني لم أكن أعرف من أين أبدأ. الفريق كان معي في كل خطوة من تجهيز الملفات حتى وصلت إسطنبول وبدأت دراستي. أنصح كل طالب عربي بالتواصل معهم.",
    year: "2023",
  },
  {
    name: "نور الحسن",
    ...
    text: "ما يميز منصة د/ يسرا هو الاهتمام الشخصي بكل طالب. لم أشعر يوماً أنني مجرد رقم بينهم. ساعدوني في الحصول على قبول في جامعة بيلكنت المرموقة ورتّبوا لي كل شيء من السكن لأوراق الإقامة. تجربة لا تُنسى!",
    year: "2024",
  },
  {
    name: "عمر بن يوسف",
    ...
    text: "كان حلمي الدراسة في كلية الطب التركية وقد حققته بفضل فريق د/ يسرا. ساعدوني في فهم متطلبات القبول وترجمة وثائقي وقدموا لي دعماً نفسياً ومعنوياً خلال فترة الانتظار. الآن أنا في السنة الثانية طب في أنقرة.",
    year: "2023",
  },
  {
    name: "فاطمة الزهراوي",
  ...
  },
  {
    ...
    text: "جامعة بوغازيتشي كانت حلماً يبدو بعيد المنال، لكن منصة د/ يسرا جعلته حقيقة. ساعدوني في تجهيز ملف استثنائي وأجروا معي تدريبات على المقابلة. اليوم أنا طالب ماجستير في الذكاء الاصطناعي في واحدة من أرقى جامعات تركيا.",
    year: "2024",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
            اقرأ ما يقوله طلابنا عن تجربتهم مع منصة د/ يسرا التعليمية
          </p>
